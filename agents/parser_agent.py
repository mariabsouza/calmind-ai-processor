...
class ParserAgent:    
    ...
    def __init__(self, original_content):
        self.prompt = f"Conteúdo a ser analisado: {original_content}"
        ...
        self.agent_config = types.GenerateContentConfig(
                ...
                *Formato de Saída Obrigatório:*
                Sua resposta final deve ser EXCLUSIVAMENTE um objeto JSON válido, sem nenhum texto, explicação ou comentários adicionais. Siga rigorosamente a estrutura esperada.""")